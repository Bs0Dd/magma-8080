...
;	Добавление блока 64-бит до имитовставки | Add 64-bit block to Message Authentication Code
...
;	Очистка зоны имитовставки | Clearing the Message Authentication Code area
